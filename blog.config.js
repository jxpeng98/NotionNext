...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'folio', // 主题， 支持 ['next','hexo',"fukasawa','medium','example','matery','gitbook','simple'] @see https://preview.tangly1024.com
  ...
  WEBURL: process.env.NEXT_PUBLIC_WEBURL || 'https://www.jiaxinpeng.com', // 您的网站地址
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.pengjiaxin.com', // 网站地址
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://minioapi.pjx.ac.cn/img1/2023/10/7e884bfce4e69e53052409b76f5f85cc.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  GONGAN_BEIAN: process.env.NEXT_PUBLIC_GONGAN_BEIAN || '', // 公安备案号
  // START********代码相关********
  // PrismJs 代码相关
