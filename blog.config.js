...
const BLOG = {
  ...
  FONT_URL: [
    ...
    // 'https://cdnjs.cloudflare.com/ajax/libs/lxgw-wenkai-webfont/1.7.0/style.css',
  ...
  // PRISM_THEME_PATH,
  // Original link: 'https://npm.elemecdn.com/prism-themes/themes/prism-coy.css'
  PRISM_THEME_SWITCH: true, // 是否切换代码块主题
  PRISM_THEME_PREFIX_PATH: 'https://npm.elemecdn.com/prismjs@1.29.0/themes/prism-okaidia.css', // 固定代码块主题
  PRISM_THEME_LIGHT_PATH:
    'https://npm.elemecdn.com/prismjs@1.29.0/themes/prism-solarizedlight.css', // 代码样式主题 更多参考 https://github.com/PrismJS/prism-themes
  PRISM_THEME_DARK_PATH:
    'https://npm.elemecdn.com/prismjs@1.29.0/themes/prism-okaidia.css', // 代码样式主题 更多参考 https://github.com/PrismJS/prism-themes
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,email', // 'link,wechat,qq,weibo,email,facebook,twitter,telegram,messenger,line,reddit,whatsapp,linkedin', // 分享的服務，按顺序显示,逗号隔开
  // 所有支持的分享服务：link(复制链接),wechat(微信),qq,weibo(微博),email(邮件),facebook,twitter,telegram,messenger,line,reddit,whatsapp,linkedin,vkshare,okshare,tumblr,livejournal,mailru,viber,workplace,pocket,instapaper,hatena

  POST_URL_PREFIX: process.env.NEXT_PUBLIC_POST_URL_PREFIX || 'article/%year%/%month%/%day%', // 文章路径前缀
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Jiaxin Blog', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
