...
const Footer = ({ title }) => {
  ...
  return (
    ...
    >
       {/* <DarkModeButton/> */}
      <i className='fas fa-copyright' /> {`${copyrightDate}`} <span><i className='mx-1 animate-pulse fas fa-heart'/> <a href={BLOG.WEBURL} className='underline font-bold text-gray-500 dark:text-gray-300 '>{BLOG.AUTHOR}</a><br/>
