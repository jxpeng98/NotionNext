  ...
  return (
      <LayoutBase {...props} slotRight={slotRight} headerSlot={headerSlot}>
        <div id="post-outer-wrapper" className="px-5 md:px-0">
          <div className="px-3">
            <p className="text-4xl font-extrabold dark:text-gray-200 mb-5 pt-10">
                {CONFIG.FOLIO_NAME}
            </p>
          </div>
            {/* Bibliography */}
          <div className="px-3">
            <p className="text-xl font-regular dark:text-gray-200 mb-5 pt-10">
                {CONFIG.FOLIO_BIBLIOGRAPHY}
            </p>
          </div>

          <div className="w-full h-auto">
            <p style={{ textAlign: 'right' }}>{CONFIG.FOLIO_ADDRESS}</p>
            <br />
            <p style={{ textAlign: 'right' }}>
              <a href={`tel:${CONFIG.FOLIO_PHONE}`}>{CONFIG.FOLIO_PHONE}</a>
            </p>
            <br />
            <p style={{ textAlign: 'right' }}>
              <a href={`mailto:${CONFIG.FOLIO_EMAIL}`}>{CONFIG.FOLIO_EMAIL}</a>
            </p>
          </div>
        </div>
      </LayoutBase>
