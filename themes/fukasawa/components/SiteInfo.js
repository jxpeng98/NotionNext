...
function SiteInfo ({ title }) {
  ...
  return (
        ...
        >
            <span> © {`${copyrightDate}`} <span> <a href={BLOG.WEBURL} className='text-gray-500 dark:text-gray-300 '> <i className='mx-1 animate-pulse fas fa-heart'/> {BLOG.AUTHOR}</a><br /></span>
