...
export default function ReadingProgress() {
  ...
  return (<div
        ...
        className={`${scrollPercentage > 0 ? 'w-10 h-10 ' : 'w-0 h-0 opacity-0'} group cursor-pointer  dark:hover:bg-gray-100 dark:hover:bg-opacity-10 hover:bg-black hover:bg-opacity-10 rounded-full flex justify-center items-center duration-200 transition-all`}
    >
