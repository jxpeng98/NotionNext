        ...
        >
            ...
            <div id='footer-bottom' className='w-full h-20 flex flex-col p-3 lg:flex-row justify-between px-6 items-center bg-[#f1f3f7] dark:bg-[#30343f]'>
                ...
                <div id='footer-bottom-left'>
                   Powered by <a href='https://github.com/tangly1024/NotionNext' className='underline font-bold  dark:text-gray-300 ' >NotionNext</a> {BLOG.VERSION} <i className='fas fa-copyright' /> {`${copyrightDate}`} <i className='mx-1 animate-pulse fas fa-heart' /> <a href={BLOG.WEBURL} className='underline font-bold  dark:text-gray-300 '>{BLOG.AUTHOR}</a>
                </div>
